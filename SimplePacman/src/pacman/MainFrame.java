...
implements KeyListener, ActionListener, WindowListener
{
	...
	void initGUI()
	{
		...
		about.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(MainFrame.this, "<html>SimplePacman<br><br>- by Эмилия, Адиля и Юля<br><br></html>",
	...
	public void initImages()
	{
		...
		imgScore=createImage(150,SIZE_);
		imgScoreG=imgScore.getGraphics();
		imgHiScore=createImage(150,SIZE_);
